...
Please install and activate it before starting to use the theme TheGig.
...
Theme documentation is available on https://thegig.axiomthemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in TheGig is Fontello.
