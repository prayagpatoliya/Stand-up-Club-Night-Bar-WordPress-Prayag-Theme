...
if ( ! function_exists( 'thegig_woocommerce_get_css' ) ) {
	add_filter( 'thegig_filter_get_css', 'thegig_woocommerce_get_css', 10, 2 );
	function thegig_woocommerce_get_css( $css, $args ) {
...
$fdir = thegig_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
    require_once $fdir;
}