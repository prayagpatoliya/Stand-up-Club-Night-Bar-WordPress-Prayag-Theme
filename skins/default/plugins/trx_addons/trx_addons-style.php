...
if ( ! function_exists( 'thegig_trx_addons_get_css' ) ) {
	add_filter( 'thegig_filter_get_css', 'thegig_trx_addons_get_css', 10, 2 );
	function thegig_trx_addons_get_css( $css, $args ) {
