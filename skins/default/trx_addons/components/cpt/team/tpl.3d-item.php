...
?>>
	...
	trx_addons_get_template_part('templates/tpl.featured.php',
								...
								apply_filters( 'trx_addons_filter_args_featured', array(
												...
												'thumb_bg' => true,
												'hover' => 'info_anim',
												'thumb_size' => thegig_get_thumb_size('full'),
...
if ( !function_exists( 'thegig_sc_icons_merge_scripts' ) ) {
	add_action("trx_addons_filter_merge_scripts", 'thegig_sc_icons_merge_scripts');
	function thegig_sc_icons_merge_scripts($list) {
